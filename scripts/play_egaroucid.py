...
The RL model is loaded **once** at start-up and kept in memory, and is never
modified — this is an evaluation tool.  Our own engine referees legality /
passing / termination (PROJECT_SPEC); Egaroucid is asked only for its own moves.
...
def main(argv=None) -> int:
    ...
    print(f"  net: {info['network']}  ·  {info['params']:,} params  ·  "
          f"trained env-steps {info['train_env_steps']:,}")
